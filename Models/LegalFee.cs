...
[Index(nameof(IdPublic), IsUnique = true, Name = "legal_fees_id_public_key")]
[Table("legal_fees")]
public partial class LegalFee
{
    ...
    [NotMapped]
    public ICollection<LegalFeeInstallment> LegalFeeInstallments { get; set; } = new List<LegalFeeInstallment>();
    ...
    public List<LegalFeeInstallment> CreateInstallments()
    {
        ...
        var installments = new List<LegalFeeInstallment>();
        ...
        for (int i = 0; i < QuantityInstallment; i++)
        {
            ...
            var installment = new LegalFeeInstallment
            {
                ReferenceId = Id,
    ...
    public LegalFeeInstallment AddInstallment(decimal valueInstallment, DateOnly dueDate)
    {
